...
NUMBER_OF_ENTRIES = 15 # serao sorteados numeros de 0 ate 15 gerando 4bits
...
def function(term_x, term_y, term_w, term_z):
    result_term_x = 5 * term_x
    result_term_y = term_y * term_y
    result_term_w = term_w
    result_term_z = term_z * term_z * term_z
